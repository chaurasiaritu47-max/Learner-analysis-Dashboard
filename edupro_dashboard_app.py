...
# use the st.title if working on local computer as the color is not working on github, use css one line css
...
<h1 style='text-align: center; color: purple;'>"Learner Demographics and Course Enrollment Behavior Analysis on EduPro"</h1>

<h2 style='text-align: center; color: #6a0dad;'>Key Performance Indicators (KPIs)</h2>
...
# as the color is not working on github, use the st.markdown to add color to the subheader as <h2></h2>
...
with col1:
    st.markdown("<h3 style='text-align: center; color: #800080;'>Age Distribution</h3>", unsafe_allow_html=True) 
    # use this if working on loacal computer st.subheader("Age Distribution")
...
with col2:
    ...
    st.markdown("<h3 style='text-align: center; color: #800080;'>Course Popularity</h3>", unsafe_allow_html=True)
    #use this line if working on local computer st.subheader("Course Popularity")
...
with col3:
    st.markdown("<h3 style='text-align: center; color: #800080;'>Gender vs Course Level</h3>", unsafe_allow_html=True)
    # use this if workingon local computer st.subheader("Gender vs Course Level")
...
with col4:
    st.markdown("<h3 style='text-align: center; color: #800080;'>Age vs Course Heatmap</h3>", unsafe_allow_html=True)
    # use this if working on local computer st.subheader("Age vs Category Heatmap")
